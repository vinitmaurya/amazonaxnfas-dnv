...
router.get("/", /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(req, res) {
    var category, searchKeyword, sortBrand, sortOrder, products;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            sortBrand = req.query.sortBrand ? {
              brand: {
                $regex: req.query.sortBrand
              }
            } : {}; //what to write here
            ...
            _context.next = 6;
            return _productModel["default"].find(_objectSpread(_objectSpread(_objectSpread({}, category), searchKeyword), sortBrand)).sort(sortOrder);
